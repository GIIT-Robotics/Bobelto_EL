...
int16_t MPU6050_read_magn(int axis)
{
	...
	{
		//- Eje X
		tmp[0] = TWI_read_sensor(AK8963_ADDRESS,0x04);
		tmp[1] = TWI_read_sensor(AK8963_ADDRESS,0x03);
	}
	else if (axis == 2)
	{
		//- Eje Y
		tmp[0] = TWI_read_sensor(AK8963_ADDRESS,0x06);
		tmp[1] = TWI_read_sensor(AK8963_ADDRESS,0x05);
	}
	else if (axis == 3)
	{
		//- Eje Z
		tmp[0] = TWI_read_sensor(AK8963_ADDRESS,0x08);
		tmp[1] = TWI_read_sensor(AK8963_ADDRESS,0x07);
	}
	else
	{
		tmp[0] = 0xFF;
